...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.BIRCHY_ORE, multipleOreDrops(ModBlocks.BIRCHY_ORE, ModItems.BIRCHY_CHUNK, 1, 2));
        addDrop(ModBlocks.BIRCHY_DEEPSLATE_ORE, multipleOreDrops(ModBlocks.BIRCHY_DEEPSLATE_ORE, ModItems.BIRCHY_CHUNK, 1, 4));
