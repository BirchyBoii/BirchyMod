...
public class ModTrimPatterns {
    public static final RegistryKey<ArmorTrimPattern> BIRCHY = RegistryKey.of(RegistryKeys.TRIM_PATTERN,
            Identifier.of(BirchyMod.MOD_ID, "birchy"));

    public static void bootstrap(Registerable<ArmorTrimPattern> context) {
        register(context, ModItems.BIRCHY_SMITHING_TEMPLATE, BIRCHY);
    }
